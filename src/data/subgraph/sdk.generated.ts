...
export function getSdk(
  ...
  return {
    ...
    daoTokenOwners(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DaoTokenOwnersQuery>(
            DaoTokenOwnersDocument,
            variables,
            {
              ...requestHeaders,
              ...wrappedRequestHeaders,
    ...
    exploreDaosPage(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ExploreDaosPageQuery>(
            ExploreDaosPageDocument,
            variables,
            {
              ...requestHeaders,
              ...wrappedRequestHeaders,
