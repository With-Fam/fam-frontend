...
import { Button, ImageUpload } from '@/components/shared'
...
const AddCrowdfund = (): JSX.Element => (
  <div className="mx-auto max-w-[668px]">
    ...
    <Paragraph as="p4" className="py-6 text-left text-grey">
      Choose an amount you&apos;d like to raise and set the crowdfund duration.
      If you do not reach the fundraising goal contributors will be refunded
    </Paragraph>
    <TextInput
      name="goal"
    ...
    <AddActionButton
      activityId="39"
      watchStates={['action-title', 'goal', 'image']}
    />
  </div>
)
