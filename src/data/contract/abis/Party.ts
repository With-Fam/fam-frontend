export const partyAbi = [
  {
    inputs: [
      { internalType: 'contract IGlobals', name: 'globals', type: 'address' },
    ],
  ...
  { inputs: [], name: 'BadPreciousListError', type: 'error' },
  {
    inputs: [
  ...
  {
    inputs: [
      { internalType: 'uint40', name: 'rageQuitTimestamp', type: 'uint40' },
    ],
    name: 'CannotRageQuitError',
    type: 'error',
  },
  { inputs: [], name: 'DistributionsRequireVoteError', type: 'error' },
  {
    inputs: [
  ...
  {
    inputs: [
      { internalType: 'uint40', name: 'maxExecutableTime', type: 'uint40' },
  ...
  {
    inputs: [{ internalType: 'int192', name: 'i192', type: 'int192' }],
  ...
  { inputs: [], name: 'InvalidDelegateError', type: 'error' },
  {
    inputs: [{ internalType: 'uint256', name: 'value', type: 'uint256' }],
    name: 'InvalidGovernanceParameter',
    type: 'error',
  },
  { inputs: [], name: 'InvalidNewHostError', type: 'error' },
  { inputs: [], name: 'InvalidTokenOrderError', type: 'error' },
  { inputs: [], name: 'MismatchedPreciousListLengths', type: 'error' },
  {
    inputs: [
  ...
  { inputs: [], name: 'NothingToBurnError', type: 'error' },
  { inputs: [], name: 'OnlyDelegateCallError', type: 'error' },
  { inputs: [], name: 'OnlyWhenEmergencyActionsAllowedError', type: 'error' },
  { inputs: [], name: 'OnlyWhenEnabledError', type: 'error' },
  { inputs: [], name: 'PartyNotStartedError', type: 'error' },
  {
    inputs: [
      { internalType: 'uint40', name: 'currentTime', type: 'uint40' },
      { internalType: 'uint40', name: 'cancelTime', type: 'uint40' },
    ],
  ...
  { inputs: [], name: 'TooManyHosts', type: 'error' },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        components: [
          { internalType: 'uint40', name: 'maxExecutableTime', type: 'uint40' },
          { internalType: 'uint40', name: 'cancelDelay', type: 'uint40' },
  ...
  {
    inputs: [
      { internalType: 'address', name: 'newPartyHost', type: 'address' },
    ],
    name: 'abdicateHost',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'snapIndex', type: 'uint256' },
    ],
    name: 'accept',
  ...
  {
    inputs: [{ internalType: 'uint96', name: 'votingPower', type: 'uint96' }],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'address', name: 'token', type: 'address' },
          { internalType: 'uint128', name: 'memberSupply', type: 'uint128' },
          { internalType: 'uint128', name: 'fee', type: 'uint128' },
          { internalType: 'uint96', name: 'totalShares', type: 'uint96' },
        ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bytes', name: 'progressData', type: 'bytes' },
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: 'uint40', name: 'voteDuration', type: 'uint40' },
          { internalType: 'uint40', name: 'executionDelay', type: 'uint40' },
          { internalType: 'uint16', name: 'passThresholdBps', type: 'uint16' },
          { internalType: 'uint96', name: 'totalVotingPower', type: 'uint96' },
        ],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'bool', name: 'allowOperators', type: 'bool' },
          {
  ...
  },
  {
    ...
    outputs: [
      ...
      {
        components: [
          { internalType: 'uint40', name: 'proposedTime', type: 'uint40' },
          { internalType: 'uint40', name: 'passedTime', type: 'uint40' },
          { internalType: 'uint40', name: 'executedTime', type: 'uint40' },
          { internalType: 'uint40', name: 'completedTime', type: 'uint40' },
          { internalType: 'uint96', name: 'votes', type: 'uint96' },
          { internalType: 'uint96', name: 'totalVotingPower', type: 'uint96' },
          { internalType: 'uint8', name: 'numHosts', type: 'uint8' },
          { internalType: 'uint8', name: 'numHostsAccepted', type: 'uint8' },
          { internalType: 'uint40', name: 'voteDuration', type: 'uint40' },
          { internalType: 'uint40', name: 'executionDelay', type: 'uint40' },
          { internalType: 'uint16', name: 'passThresholdBps', type: 'uint16' },
        ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'latestSnapIndex', type: 'uint256' },
    ],
    name: 'propose',
  ...
  {
    inputs: [
      { internalType: 'uint40', name: 'newRageQuitTimestamp', type: 'uint40' },
    ],
    name: 'setRageQuit',
    outputs: [],
    stateMutability: 'nonpayable',
