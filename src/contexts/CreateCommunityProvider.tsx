...
export interface CreateCommunityContextType {
  ...
  setHypersubAddress: (address: Address) => void
}
...
const useCreateCommunityProvider = (): CreateCommunityContextType =>
  useContext(CreateCommunityContext)

export { CreateCommunityProvider, useCreateCommunityProvider }
